...
from rsl_rl.modules import ActorCritic, ActorCriticCNN, ActorCriticRecurrent, ActorCriticExtrinsics
...
class PPO:
    ...
    policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticExtrinsics
